...
$title = "i-40N Comfort oortje met microfoon en doosje";
// Stel de typenummers in voor het hoofdproduct en de variant met zakjes
$TypeNummerHoofd = "i-40N";
...
<style>
    ...
    .grid-container {
        grid-template-areas:
            ...
            "usp usp usp twee twee twee"
            "drie drie zeven zeven zeven zeven"
            "acht acht acht acht acht acht";
        grid-template-rows: 1fr 4fr 2fr auto 5fr;
        height: 3000px;
    }
...
<body>
    ...
    <article class='grid-container'>
        <div class="een">
            <img class='breed' src="i-40n I in doosje.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="twee geenpad">
            <img class='hoog' src="i40 portugal 16-12-2024 hangend.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="acht geenpad">
            <img class='hoog' src="i-40 N in verpakking.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
