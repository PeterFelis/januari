...
<body>
    ...
    <article class='grid-container'>
        <div class="een">
            <img class='hoog' src="BT9drie.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="twee geenpad">
            <img class='breed' src="hangende foto BT-9, uitgeknipt, bijgewerkt 25032025.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="acht">
            <img class='hoog' src="BT9twee.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>



        <div class="elf">
            <img class='hoog' src="BT9vier.png" alt='HP-305 in een zakje' loading="lazy">
        </div>
