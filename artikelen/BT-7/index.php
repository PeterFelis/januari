...
<body>
    ...
    <article class='grid-container'>
        <div class="een geenpad">
            <img class='breed' src="liggend.jpg" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="twee">
            <img class='breed' src="front groot uitgeknipt, bewerkt, 25032025.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="vier geenpad">
            <img class='breed' src="op bank in tuin.jpg" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="acht">
            <img class='hoog' src="BT front uitgeknipt.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>

        <div class="elf">
            <img class='hoog' src="BT-7 bovenaf hangend uitgeknipt bewerkt 25032025.png" alt='HP-305 in een zakje' loading="lazy">
        </div>


        <div class="twaalf geenpad">
            <img class='breed' src="kabels+hoofdtel.jpg" alt='HP-305 in een zakje' loading="lazy">
        </div>
