...
<body>
    ...
    <!-- Sectie 2: Variant met zakjes -->
    <section id="variantZakjes" class="product-section">
        <h1><?php echo htmlspecialchars($variantProduct['TypeNummer']); ?></h1>
        <div id="usp"><?php echo $variantProduct['USP']; ?></div>
        <div class="omschrijving"><?php echo $variantProduct['omschrijving']; ?></div>
        <!-- Een eventueel ander prijsblok voor de variant -->
        <?php include '../prijs_component.php'; ?>
    </section>
