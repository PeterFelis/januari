...
<style>
    ...
    .grid-container {
        grid-template-areas:
            ...
            "dertien dertien dertien dertien dertien dertien"
            "drie drie zeven zeven zeven zeven"
            "vier vier vier vier vijf vijf"
            "acht acht elf elf elf elf";
        grid-template-rows: 1fr 3fr 2fr 4fr auto 3fr 3fr;
        height: 3000px;
    }
...
<body>
    ...
    <article class='grid-container'>
        <div class="een">
            <img class='hoog' src="USBfotonietuitgeknipt.jpg" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="twee geenpad">
            <img class='breed' src="schuinhangenduitgeknipt.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="dertien geenpad">
            <img class='breed' src="met_octopus.jpg" alt='HP-305 in een zakje' loading="lazy">
        </div>
        ...
        <div class="vier">
            <img class='hoog' src="liggend_uitgeknipt_ingeklapt.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="vijf">
            <img class='hoog' src="uitgeknipt.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        ...
        <div class="acht">
            <img class='hoog' src="frontuitgeknipt.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>


        <div class="elf">
            <img class='hoog' src="liggend_uitgeknipt-met-snoer.png" alt='HP-305 in een zakje' loading="lazy">
        </div>
