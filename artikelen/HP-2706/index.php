...
$title = "HP-2706 budget hoofdtelefoon";
// Stel de typenummers in voor het hoofdproduct en de variant met zakjes
$TypeNummerHoofd = "HP-2706";
$TypeNummerZakjes = "HP-2706Z"; // Zorg dat dit typenummer in de database bestaat voor de variant
...
<body>
    ...
    <article class='grid-container'>
        <div class="een">
            <img class='hoog' src="2706 hangend.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
        <div class="twee">
            <img class='breed' src="_DSC3430.png" alt='hp-136 hoofdtelefoon' loading="lazy">
        </div>
