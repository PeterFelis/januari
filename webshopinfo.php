...
<div class="pag">
    <div class='koplijn'>
        <div>
            <img class='img-back' src="afbeeldingen/hp-136.jpg" alt='HP-136 koptelefoon' />
            <h1>Webshop Info</h1>
            <h3>Aankopen, VVV cheques, klant worden en wat er allemaal mogelijk is.</h3>
        </div>
        <div>
            <img src="/afbeeldingen/muis.png" />
        </div>
    </div>



    <div class="grid grid-cols-2 mx-auto mt-32 font-Raleway">
        <div class="p-16">
            <h2>Onze Klanten</h2>
        ...
        <div>
            <div class="w-full">
                <img src="/afbeeldingen/hp-136.jpg" />
            </div>
        </div>

        <div class="relative pl-16">
            <div class="object-contain svgblob bg-geel bg-opacity-30 p-10">
